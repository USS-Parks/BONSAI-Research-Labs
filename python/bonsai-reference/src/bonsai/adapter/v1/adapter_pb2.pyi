...
class PrimitiveAccounting(_message.Message):
    __slots__ = ("environment_steps", "updates", "parameter_touches", "work_items", "replay_items_retained", "parameter_update")
    ...
    PARAMETER_UPDATE_FIELD_NUMBER: _ClassVar[int]
    environment_steps: int
    updates: int
    parameter_touches: int
    work_items: int
    replay_items_retained: int
    parameter_update: bytes
    def __init__(self, environment_steps: _Optional[int] = ..., updates: _Optional[int] = ..., parameter_touches: _Optional[int] = ..., work_items: _Optional[int] = ..., replay_items_retained: _Optional[int] = ..., parameter_update: _Optional[bytes] = ...) -> None: ...
