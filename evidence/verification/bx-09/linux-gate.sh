...
uv run --frozen --offline pytest --basetemp target/bx09-linux-pytest-1788671600000 -o cache_dir=target/bx09-linux-pytest-1788671600000-cache
uv run --frozen --offline python scripts/check_python_protocol.py
