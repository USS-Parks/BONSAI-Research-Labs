...
def main() -> None:
    ...
    forbidden = re.compile(r"bonsai_reference|primitive_adapter|environment_adapter|BRDC[-_]?1", re.IGNORECASE)
    audited = {}
    for name in names:
    ...
    result = {"schema": "bonsai.adapter-dependency-audit/v1", "authority": audited,
    ...
    (ROOT / "evidence/verification/bx-09/dependency-audit.json").write_text(
