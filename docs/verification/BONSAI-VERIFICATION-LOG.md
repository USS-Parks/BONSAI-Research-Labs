...
## VER-BK01-HOSTED — BK-01 — 2026-07-19T19:56:55Z

- Source revision and dirty state: `eaa8f6d9d5ac32374e73b97575246cd9df38a84f`; clean pushed revision
- OS/architecture/physical-or-CI: Windows/x86_64, Linux/x86_64, macOS/arm64, macOS/x86_64; GitHub hosted CI; ephemeral virtual machines
- Toolchain/dependency-lock hashes: workflow-pinned Rust 1.96.0, Python 3.12, and uv 0.11.29; source locks at the recorded revision
- Command: GitHub Actions `BONSAI baseline` push run 29701573420, attempt 1
- Start/end/duration: `2026-07-19T19:56:55Z` / `2026-07-19T20:01:51Z` / 296 s
- Exit code: all four jobs concluded `success`; job IDs 88231381820 (macOS Intel), 88231381826 (Linux), 88231381828 (Windows), and 88231381832 (macOS arm64)
- Stdout/stderr artifact hashes: retained by GitHub Actions
- Fixtures/manifests/bundle IDs: registry DAG/version/missingness golden fixtures and complete existing corpus on every hosted runner
- Counter availability and privileges: deterministic analytical fixtures only; no platform or privileged counter claim
- Result: pass
- Reviewer/attestation: exact run head SHA, run conclusion, and all four matrix-job conclusions inspected through public GitHub metadata; BK-01 cross-OS gate is closed

## VER-BK02-GATE — BK-02 — 2026-07-19

- Source revision and dirty state: `eaa8f6d9d5ac32374e73b97575246cd9df38a84f`; dirty only with BK-02 implementation, governance, and evidence
- OS/architecture/physical-or-CI: Windows/x86_64; local; physical/virtual status unknown
- Toolchain/dependency-lock hashes: Rust 1.96.0; locked repository Python environment; `Cargo.lock` unchanged from BK-01
- Command: machine record `BK-02-1784491266234590700`; full universal/schema/governance gate through an external verifier copy
- Start/end/duration: machine-record Unix UTC nanoseconds `1784491266234590700` / `1784491297379179700` / 31.1454313 s
- Exit code: 0
- Stdout/stderr artifact hashes: stdout `3C50EB13E29988519BF1BEA8B427762AE63C6D2AB6AD3096F0591290E26F5A1B`; stderr `FA90D08747A3D7C60BC053CAAB97258E9D2883A978EB402E8EEB34C3A87B04B1`
- Fixtures/manifests/bundle IDs: analytical curve, comparator missingness, unrecovered change, malformed trace/window, and complete existing repository corpus
- Counter availability and privileges: deterministic analytical fixtures only; no platform or privileged counter claim
- Result: pass
- Reviewer/attestation: exact primary behavior values/units/windows, comparator-gated regret, recovery missingness, worst-window/age conditioning, and strict workspace/Python/schema/governance gates passed locally; hosted closure remains attached to the focused commit

## VER-BK02-HOSTED — BK-02 — 2026-07-19T20:04:21Z

- Source revision and dirty state: `2bc73566cc2ba66c8eec0e3a4a7d6dad08b46b61`; clean pushed revision
- OS/architecture/physical-or-CI: Windows/x86_64, Linux/x86_64, macOS/arm64, macOS/x86_64; GitHub hosted CI; ephemeral virtual machines
- Toolchain/dependency-lock hashes: workflow-pinned Rust 1.96.0, Python 3.12, and uv 0.11.29; source locks at the recorded revision
- Command: GitHub Actions `BONSAI baseline` push run 29701818896, attempt 1
- Start/end/duration: `2026-07-19T20:04:21Z` / `2026-07-19T20:09:16Z` / 295 s
- Exit code: all four jobs concluded `success`; job IDs 88232006789 (macOS Intel), 88232006806 (macOS arm64), 88232006827 (Windows), and 88232006839 (Linux)
- Stdout/stderr artifact hashes: retained by GitHub Actions
- Fixtures/manifests/bundle IDs: analytical curve, comparator/recovery missingness, trace/window rejection, and complete existing corpus on every hosted runner
- Counter availability and privileges: deterministic analytical fixtures only; no platform or privileged counter claim
- Result: pass
- Reviewer/attestation: exact run head SHA, run conclusion, and all four matrix-job conclusions inspected through public GitHub metadata; BK-02 cross-OS gate is closed

## VER-BK03-GATE — BK-03 — 2026-07-19

- Source revision and dirty state: `2bc73566cc2ba66c8eec0e3a4a7d6dad08b46b61`; dirty only with BK-03 implementation, governance, and evidence
- OS/architecture/physical-or-CI: Windows/x86_64; local; physical/virtual status unknown
- Toolchain/dependency-lock hashes: Rust 1.96.0; locked repository Python environment; `Cargo.lock` SHA-256 `E21B60A804C096CCF7FED0D3A3A58DFBD4CCF5294DFB64C5E04FA2D81B7EBDE8`
- Command: machine record `BK-03-1784491651197673300`; full universal/schema/governance gate through an external verifier copy
- Start/end/duration: machine-record Unix UTC nanoseconds `1784491651197673300` / `1784491678494673100` / 27.2977347 s
- Exit code: 0
- Stdout/stderr artifact hashes: stdout `026790852A784EC659A8746E79831C30842C49888EC1C5817B6AAB0C1B4C6EF3`; stderr `1D5621A9E41C7199CF46B674A607BBD1C5C99CE2726A03FFE9985AA1BE12B4F2`
- Fixtures/manifests/bundle IDs: calibrated known loads, unavailable energy, incomparable memory semantics, exact D-11 boundary/failure, contradictory calibration/CI, and complete existing repository corpus
...
## VER-BV01-HOSTED — BV-01 — 2026-07-19T20:51:18Z

- Source revision and dirty state: `8e5b6c0c73de79a97ffb335c5ea1033eaa3fd86f`; clean pushed revision
- OS/architecture/physical-or-CI: Windows/x86_64, Linux/x86_64, macOS/arm64, macOS/x86_64; GitHub hosted CI; ephemeral virtual machines
- Toolchain/dependency-lock hashes: workflow-pinned Rust 1.96.0, Python 3.12, and uv 0.11.29; source locks at the recorded revision
- Command: GitHub Actions `BONSAI baseline` push run 29703285273, attempt 1
- Start/end/duration: `2026-07-19T20:51:18Z` / `2026-07-19T20:56:33Z` / 315 s
- Exit code: all four jobs concluded `success`; job IDs 88235918939 (Windows), 88235918955 (Linux), 88235918924 (macOS arm64), and 88235918932 (macOS Intel)
- Stdout/stderr artifact hashes: retained by GitHub Actions
- Fixtures/manifests/bundle IDs: complete/missing/failed/contradictory evidence, prerequisite propagation, stored rule version, and complete existing corpus on every hosted runner
- Counter availability and privileges: deterministic claim-rule fixtures only; no physical-host evidence or actual agent claim
- Result: pass
- Reviewer/attestation: exact run head SHA, run conclusion, and all four matrix-job conclusions inspected through authenticated GitHub metadata; BV-01 cross-OS gate is closed

## VER-BV02-GATE — BV-02 — 2026-07-19

- Source revision and dirty state: `8e5b6c0c73de79a97ffb335c5ea1033eaa3fd86f`; dirty only with BV-02 implementation, governance, and evidence
- OS/architecture/physical-or-CI: Windows/x86_64; local; physical/virtual status unknown
...
- Command: final machine record `BV-02-1784494954420259900`; full universal/schema/governance gate through an external verifier copy after governance closeout edits
- Start/end/duration: machine-record Unix UTC nanoseconds `1784494954420259900` / `1784494978866592400` / 24.4470014 s
- Exit code: 0
- Stdout/stderr artifact hashes: stdout `9FEF2844B65829BA1788B13AA0DF33924B8C537F8E8BC1FB90414F66EBDB3259`; stderr `EE6CCF15A1EB9B7A0C80ECEBC382DD1AF89AE1EF4BEC383D7ADEB53212E1A550`
- Fixtures/manifests/bundle IDs: complete static report, hostile title escaping, null required section, malformed hash, exact JSON round trip, offline surface audit, accessibility semantics, and complete existing repository corpus
...
## BX-05 — local acceptance and publication boundary

Local acceptance passed; commit/main publication and the required hosted matrix remain pending. Final records in `evidence/verification/records.jsonl`:

- `BX-05-FINAL-LIVE-1788660814104769400`: all 11 live cases passed, including the full S run.
- `BX-05-FINAL-AUDIT-1788661207634038100`: independent complete-run/failure-fact reconciliation and five actual preflight rejections passed.
- `BX-05-ARCHIVE-1788661261708547400`: ZIP integrity, payload hashes, and 177 source files verified.
- `BX-05-WINDOWS-1788661268350607400`: 212 Rust / 59 Python tests, strict checks, schemas, and governance passed.
- `BX-05-LINUX-1788661376137051100`: 214 Rust / 59 Python tests, strict checks, and schemas passed on WSL2.

S run `4042dad0-ad3e-4db8-b883-8a2515e0f4ba` completed 2,000 steps in 56.327551905 seconds, within the 120-second cap. All 35,822 events reconcile: 2,000 actions/rewards/resource samples and 8,000 work events. Maximum action latency was 2.681421 ms and per-step CPU 1.734 ms. Observer output was 17,530,327 bytes. The final index SHA-256 is `562772bfed92395bfd707b4c6af74afe7d0f0bdb3e895e20adabf698a0a2d768`.
