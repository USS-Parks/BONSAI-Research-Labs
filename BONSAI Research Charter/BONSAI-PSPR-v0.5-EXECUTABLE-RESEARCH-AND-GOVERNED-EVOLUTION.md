...
### [x] BX-08 — Bound persistent evidence state and recover interrupted runs
...
### [x] BX-09 — Prove versioned extension contracts
...
### [x] BX-10 — Integrate a materially different agent through the same adapter
...
### [x] BX-11 — Integrate an optional external environment adapter
...
### [x] BX-12 — Discover useful feature candidates from online experience
