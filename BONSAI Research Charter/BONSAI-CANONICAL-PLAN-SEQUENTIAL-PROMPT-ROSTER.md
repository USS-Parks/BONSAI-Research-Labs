...
- [~] **BE-03 — M1 auditable heartbeat experiment.** **Depends:** BE-02, BC-12, BK-01–BK-03, BV-01–BV-03. **Files:** smoke manifest and expected bundle summary. **Objective:** run one stable diagnostic scenario end to end and emit reportable C0/C1 evidence. **Excludes:** C2+ claims. **Gate:** local four-platform semantic fixture and complete repository gate passed; Windows/macOS/Linux hosted bundle validation and aggregate equivalence remain pending on the focused commit.
