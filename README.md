...
- Implementation claims: M0 governed foundation, BC-01 through BC-12, BR-01 through BR-06, BM-01 through BM-04, BQ-01 through BQ-04, and BK-01 are complete; no instrument-completion or C0–C5 claim.
...
Analysis begins with the [versioned metric registry](./docs/metrics/REGISTRY.md); derived report values must originate in its deterministic tables.
