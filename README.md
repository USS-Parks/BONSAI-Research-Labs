...
- Implementation claims: M0 governed foundation and BC-01 through BC-09 are complete; no instrument-completion or C0–C5 claim.
...
The versioned append-only storage layout is specified in the [event segment format](./docs/architecture/EVENT-SEGMENT-FORMAT.md).
