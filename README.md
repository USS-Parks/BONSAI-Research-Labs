...
- PSPR: approved v0.1 on 2026-07-18; M2 useful-abstraction slice approved v0.2 on 2026-08-23; M3 cross-platform governed science approved v0.3 on 2026-08-24; M4 acceptance and release-candidate approved v0.4 on 2026-08-24.
- Current execution authorization: approved PSPR v0.4 M4 roster authorized by full M4 STS on 2026-08-24 (PT); prior M3 STS does not cover this work.
- Implementation claims: M0–M3 remain complete through BV-10; M4 adds the threat model, hardening suite, SBOM/offline scripts, L-profile harness, operator handoff, and in-repo release-candidate artifacts through BV-16. Hosted or container capability is not physical-host Job Object/cgroup/Apple qualification. Energy stays E0/E1 unless a collector is qualified. C4/C5 rules are executable and do not require a pass. 72-hour physical-host L evidence is not-run. No instrument-completion claim and no OaK reproduction claim.
...
M4 acceptance starts with the [threat model](./docs/security/THREAT-MODEL.md) (D-21 disclaimer prominent), [dependency policy](./docs/governance/DEPENDENCY-POLICY.md), and [long-duration harness](./docs/architecture/LONG-DURATION-ACCEPTANCE.md). Operator handoff: [install](./docs/operator/INSTALL.md), [run](./docs/operator/RUN.md), [analyze](./docs/operator/ANALYZE.md), [adapter](./docs/operator/ADAPTER.md), [metric](./docs/operator/METRIC.md), [claim](./docs/operator/CLAIM.md), [platform](./docs/operator/PLATFORM.md), and [limitations](./docs/operator/LIMITATIONS.md). Release-candidate notes stay in-repo: [RC 0.0.0](./docs/releases/RC-0.0.0-NOTES.md) and the [M4 audit](./docs/verification/M4-COMPLETION-AUDIT.md).
